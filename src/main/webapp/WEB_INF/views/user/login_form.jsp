	...
	<form action="/auth/loginProc" method="Post">
		...
		<div class="d-flex flex-column align-items-center">
			...
			<button type="submit" id="btn--login" class="btn btn-success"
				style="width: 30vh">Log-in</button>


			<hr class="social-sign-in__line">
			<span class="social-sign-in__title">간편 로그인</span> <a
				...
				<img alt="카카오 로그인 " src="/images/kakao_login.png" height="40">
			</a>
			<%
			...
			<a href="<%=apiURL%>"><img height="38"
				...
				<img alt="구글 로그인 " src="/images/google.png">
			</a>
		</div>
	</form>
</div>
