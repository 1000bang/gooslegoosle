...
<section id="banner">
	<div id="banner-wrap">
		...
		<p class="banner-in s--text">"구슬구슬 파트너"는 월 170만 사용자가 찾는 구슬구슬에서</p>
		<p class="banner-in s--text">중소형 식당의 홍보를 돕는 빅데이터 기반의 비지니스 솔루션입니다.</p>
		...
		<c:if test="${principal.user.role eq 'USER'}">
			<button type="button" class="btn" id="put-in-partner-btn">
				<a href="/partner/application_partner" id="btn-in-a" >구슬구슬 파트너
					신청하기</a>
			</button>
		</c:if>
	</div>
</section>
<section style="width: 100%; min-height: 145px;"></section>
