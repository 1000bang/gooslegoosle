			...
			<form action="" class="was-validated">
				...
				<div id="partner-info" class="info-box">
					...
					<div class="form-group">
						<label for="username">이름</label> <input type="text"
							...
							value="${princpal.user.username}" name="username" required>
					...
					<div class="form-group">
						<label for="phonenumber">휴대전화번호</label> <input type="text"
							...
							placeholder="휴대전화번호를 입력해주세요." name="phonenumber" required>
						<div class="valid-feedback">완료 !</div>
						<div class="invalid-feedback">필수 입력 사항입니다.</div>
					</div>
					<div class="form-group">
				...
				<div id="store-info" class="info-box">
					...
					<div class="form-group">
						...
						<div class="d-flex">
							<input type="text" id="postcode" placeholder="주소를 입력해주세요."
								class="form-control">
