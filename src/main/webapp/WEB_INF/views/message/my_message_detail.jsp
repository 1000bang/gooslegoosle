...
<div class="container" style="min-height: 630px">
	...
	<c:if test="${message.userId.id == principal.user.id}">
		<a class="btn btn-outline-warning" id="" href="/notice/update/${message.id}">수정</a>
		<a class="btn btn-outline-danger" id="" href="/notice/delete/${message.id}">삭제</a>
	</c:if>
	<br /> <br /> <br />
	...
	<div>
		글 작성자 : <span> <i> ${notice.userId.userNickname} </i></span>
	</div>
	<br /> <br /> <br />
	<div class="">
		<h3>${notice.title}</h3>
